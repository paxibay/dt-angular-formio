...
var FormioComponent = /** @class */ (function () {
    ...
    function (form) {
        ...
        // Create the form.
        return Formio.createForm(get(this.formioElement, 'nativeElement', null), this.form, {
    ...
    function (submission) {
        ...
        var /** @type {?} */ beforeSubmit = get(this.options, 'hooks.beforeSubmit');
        if (beforeSubmit) {
...
function FormioComponent_tsickle_Closure_declarations() {
    ...
    /** @type {?} */
    FormioComponent.prototype.readyResolve;
    /** @type {?} */
